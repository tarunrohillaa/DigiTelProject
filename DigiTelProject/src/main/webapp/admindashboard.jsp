    ...
    <div class="container p-4">
        <div class="row mt-2">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header text-white h3" style="background-color: #5a49f0;">
                     <div class="row">
                            <div class="col-6">
                                <b>Users list</b>
                            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <%
						     ...
						     try
						     {
						    	 ...
						    	 String query;
						    	 if(search!=null){
						    	  query = "SELECT * FROM userlogin WHERE id like '%"+search+"%' OR name like '%"+search+"%' OR telenumber like'%"+search+"%'";
						    	 }
						    	 else{
						    	   query="SELECT ID, NAME,TELENUMBER,EMAIL,PASSWORD FROM userlogin";
						    	 }
